# Setting up an X server on Windows
...
You have successfully configured Xming to run the X server. You can now proceed to the [next step](docker-javafx-guide.md#running-the-docker-container).